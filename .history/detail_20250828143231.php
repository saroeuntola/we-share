            ...
            <div class="bg-gray-800 text-white p-3">
                ...
                <div class="text-gray-200">
                    ...
                    <p class="bg-yellow-100 text-yellow-800 p-4 rounded-lg border-l-4 border-yellow-500 text-sm md:text-base">
                        <strong>Note:</strong> Documents or software hosted on <span class="font-semibold">WeShare.com</span> are not owned by this site. We do not hold any. If you are the copyright owner and wish to request removal, please <a href="/contact" class="underline text-blue-600 hover:text-blue-800">contact us</a> and we will remove it promptly.
                    </p>
