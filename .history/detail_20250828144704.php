    ...
    <main class="max-w-7xl mx-auto p-2 mt-[80px]">
        <div class="overflow-hidden mb-10">
            ...
            <div class="bg-gray-800 text-white p-3">
                ...
                <!-- Text content -->
                <p class="mb-3">
                    <span class="font-semibold"><?= $lang === 'en' ? 'Category' : 'ប្រភេទ' ?>:</span> <?= $category ? htmlspecialchars($category['name']) : '-' ?>
                    <span class="font-semibold">,</span> <?= $subcategory ? htmlspecialchars($subcategory['name']) : '-' ?><br>
                    <span class="font-semibold"><?= $lang === 'en' ? 'Category' : 'ប្រភេទ' ?>Post by:</span> <?= htmlspecialchars($post['added_by']) ?><br>
