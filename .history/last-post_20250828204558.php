    ...
    <main class="max-w-7xl m-auto p-2 mt-[80px]">
        <div class="">
            <a href="index?lang=<?= $lang ?>"
                class="inline-flex justify-end items-center text-white hover:text-green-400 transition mb-6 <?= $lang === 'kh' ? 'khmer-font' : '' ?>">
                <!-- Arrow Icon -->
            ...
            <div class="flex items-center justify-between jus">
                <h1 class="lg:text-3xl text-2xl font-bold text-white <?= $lang === 'kh' ? 'khmer-font-kulen' : '' ?>"><?= $lang === 'en' ? 'Latest Posts' : 'ការបង្ហោះថ្មីៗ' ?></h1>

                <!-- CATEGORY FILTER -->
                <div class="relative inline-block mb-4 mt-3">
                    <button id="dropdownButton" type="button"
                        class="text-white bg-blue-700 hover:bg-green-600 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center <?= $lang === 'kh' ? 'khmer-font' : '' ?>"
