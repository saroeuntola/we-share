...
<nav class="bg-green-500 shadow-md w-full" id="header">
    <div class="max-w-7xl mx-auto px-2">
        ...
        <!-- Slide-in Menu -->
        <div id="mobile-menu"
            class="fixed top-0 left-0 h-full w-64 bg-green-800 text-white transform -translate-x-full transition-transform duration-300 ease-in-out z-50">

            <div class="flex flex-col px-5 py-5 space-y-4">
                <button id="close-btn" class="self-end text-white">
                    ✕
                </button>
                <?= navItem('/', $menu['home'], $lang, $currentPage, $currentSlug) ?>
                <?= navItem('services', $menu['services'], $lang, $currentPage, $currentSlug) ?>
