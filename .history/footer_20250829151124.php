    ...
    <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 ">
        ...
        <div class="mt-6">
            ...
            <ul class="space-y-2 text-sm">
                ...
                <li><a href="windows-server?lang=<?= $lang ?>" class="hover:text-green-400 transition">Database</a></li>
                <li><a href="windows-server?lang=<?= $lang ?>" class="hover:text-green-400 transition">Ebooks</a></li>
                <li><a href="windows-server?lang=<?= $lang ?>" class="hover:text-green-400 transition">Microsoft Office</a></li>
                <li><a href="windows-server?lang=<?= $lang ?>" class="hover:text-green-400 transition">Software</a></li>
            </ul>
        </div>
        <!-- Social Media -->
        <div class="mt-6">
