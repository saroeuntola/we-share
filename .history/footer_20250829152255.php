    ...
    <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 ">
        ...
        <div class="mt-6 me-4">
            ...
            <p class="text-sm leading-relaxed text-wrap">
               <?= $lang === 'en' ? 'We Share is a free platform offering Khmer-language documents, study materials, IT document, and free PDF downloads. Our goal is to provide accessible learning materials to everyone and promote knowledge sharing across all fields.' : 'We Share គឺជាវែបសាយមួយដែលផ្តល់ឯកសារភាសាខ្មែរ សម្ភារៈសិក្សា ឯកសារ IT និង PDF ដោយឥតគិតថ្លៃ។ គោលបំណងរបស់យើងគឺចែករំលែកឯកសារសម្រាប់ការសិក្សា និងការស្វែងយល់សម្រាប់មនុស្សគ្រប់គ្នា។' ?>
                We Share is a free platform offering Khmer-language documents, study materials, IT document, and free PDF downloads. Our goal is to provide accessible learning materials to everyone and promote knowledge sharing across all fields.
            </p>
        </div>
