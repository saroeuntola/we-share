            ...
            <div class="flex items-center justify-between">
                ...
                <div class="relative inline-block mb-4 mt-3">
                    <button id="dropdownButton" type="button"
                        class="text-white  hover:bg-green-600 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center <?= $lang === 'kh' ? 'khmer-font' : '' ?>"
