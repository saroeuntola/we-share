                ...
                <div class="flex space-x-6 items-center">
                    ...
                    <div class="relative">
                        <button id="lang-btn-desktop" class="flex items-center text-white px-3 py-2 rounded-md hover:bg-green-600 focus:outline-none">
                            <img id="lang-flag-desktop" src="./assets/img/flags/<?= $lang === 'en' ? 'Flag_of_the_United_Kingdom' : 'khmer-flag' ?>.svg" class="w-6 h-4 ml-2 rounded-sm" alt="Flag">
                            <span class="ml-2 font-medium class=" text-right <?= $lang === 'en' ? 'khmer-font mt-1' : '' ?>""><?= $lang === 'en' ? 'English' : 'Khmer' ?></span>
