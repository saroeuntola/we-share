...
<section class="px-2">
    <div class="flex justify-between items-center">
        <h1 class="text-xl lg:text-3xl md:text-2xl font-bold text-white <?= $lang === 'kh' ? 'khmer-font-kulen' : '' ?>"><?= $lang === 'en' ? 'Programming' : 'ឯកសារ រសរសេរកម្មវិធី' ?></h1>
        <a href="programming?lang=lang=<?= $lang ?>"
