<footer class="bg-gray-900 text-gray-300 mt-10">
    <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 ">
        ...
        <div class="mt-6">
            ...
            <h2 class="text-lg font-semibold text-white mb-2 <?= $lang === 'kh' ? 'khmer-font-kulen' : '' ?>"><?= $lang === 'en' ? 'Documents' : ' <h2 class="text-lg font-semibold text-white mb-2 <?= $lang === 'kh' ? 'khmer-font' : '' ?>"><?= $lang === 'en' ? 'Documents' : 'ឯកសារ' ?></h2>' ?></h2>
