...
<footer class="bg-gray-900 text-gray-300 mt-10">
    <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 ">
        ...
        <div class="mt-6">
            ...
            <ul class="space-y-2 text-sm">
                <li><a href="web-development?lang=<?+?>" class="hover:text-green-400 transition">Web Development</a></li>
                <li><a href="/it-tutorials" class="hover:text-green-400 transition">Programming</a></li>
                <li><a href="/it-tutorials" class="hover:text-green-400 transition">Linux System</a></li>
                <li><a href="/it-tutorials" class="hover:text-green-400 transition">Windows Server</a></li>
                <li><a href="/it-tutorials" class="hover:text-green-400 transition">Database</a></li>
                ...
                <li><a href="/study-materials" class="hover:text-green-400 transition">Software</a></li>
            </ul>
        </div>
        <!-- Social Media -->
        <div class="mt-6">
