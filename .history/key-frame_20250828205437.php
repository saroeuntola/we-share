...
<div id="main">
    ...
    <div class="container">
        <!-- Sliding text -->
        <p class="announcement<?= $lang ?>"><?= $lang === 'en' ? 'Welcome! Download free PDF documents, study materials, and guides for learning.' : 'សូមស្វាគមន៍! អ្នកអាចទាញយកឯកសារ PDF សម្រាប់សិក្សា និងយល់ដឹងបន្ថែមពីមុខវិជ្ជាទាំងអស់ដោយឥតគិតថ្លៃ។' ?></p>
    </div>
</div>