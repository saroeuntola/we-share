<footer class="bg-gray-900 text-gray-300 mt-10">
    <div class="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <!-- About -->
        <div>
            <h2 class="text-lg font-semibold text-white mb-4 mt-4">We Share</h2>
            <p class="text-sm leading-relaxed">
                We Share is a free resource hub for Khmer documents, study materials, IT tutorials, and PDF downloads.
                Our mission is to make knowledge accessible for everyone in Cambodia and beyond.
            </p>
        </div>
