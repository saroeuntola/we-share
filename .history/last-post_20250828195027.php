    ...
    <main class="max-w-7xl m-auto p-2 mt-[80px]">
        <div class="">
            <a href="index?lang=<?= $lang ?>"
                class="inline-flex justify-end items-center text-white hover:text-green-400 transition mb-6 <?= $lang === 'kh' ? 'khmer-font' : 'ត្រឡប់ទៅទំព័រដើម' ?>">
                <!-- Arrow Icon -->
            ...
            <h1 class="lg:text-3xl text-2xl font-bold text-white">Lastest Posts</h1>
