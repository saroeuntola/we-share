        ...
        <div class="overflow-hidden mb-10">
            ...
            <div class="bg-gray-800 text-white p-3">
                ...
                <p class=" text-red-500 rounded-lg text-sm md:text-base mt-4">
                    <strong>Note:</strong> Documents or software hosted on <span class="font-semibold">weshare.com</span> are not owned by this site. If you are the copyright owner and wish to request removal, please <a href="/contact" class="underline text-blue-500 hover:text-blue-800">contact us</a> and we will remove it promptly.
                </p>
