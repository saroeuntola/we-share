...
class Post
{
    ...
    public function getPostNolang($limit = null)
    {
        $sql = "SELECT id, name AS name_en, name_kh AS name_kh,
                   description AS description_en, description_kh AS description_kh,
