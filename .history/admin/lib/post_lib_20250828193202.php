...
class Post
{
    ...
    public function getPostsNolang($limit = null)
    {
        $sql = "SELECT 
                id,
                name AS name_en,
    ...
    public function getPostBySlugNolang($slug)
    {
        $sql = "SELECT id, name AS name_en, , name_kh, description, description_kh, link, image, category_id, subcategory_id, created_at, added_by
            FROM posts
            WHERE slug = :slug
            LIMIT 1";
