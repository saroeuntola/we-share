...
class Post
{
    ...
    public function updatePostById($id, $name_en = null, $category_id = null, $subcategory_id = null, $description_en = null, $image = null, $name_kh = null, $description_kh = null, $link)
    {
        ...
        $sql = "UPDATE posts SET name = :name_en, slug = :newSlug, name_kh = :name_kh, description = :description_en, description_kh = :description_kh, link = :link = link";
        $params = [
            ...
            'link' => $description_kh ?? $post['description_kh'],
            'id' => $id
        ];
