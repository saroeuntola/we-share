    ...
    <main class="max-w-7xl mx-auto p-2 mt-[80px]">
        <div class="overflow-hidden mb-10">
            ...
            <div class="bg-gray-800 text-white p-3">
                ...
                <!-- Text content -->
                <p class="mb-3">
                    <span class="font-semibold">Category:</span> <?= $category ? htmlspecialchars($category['name']) : '-' ?>
                    <span class="font-semibold">,</span> <?= $subcategory ? htmlspecialchars($subcategory['name']) : '-' ?><br>
                    <span class="font-semibold">Post by:</span> <?= htmlspecialchars($post['added_by']) ?><br>
                    <span class="font-semibold">Post Date:</span> <?= htmlspecialchars($post['created_at']) ?>
                </p>

                <div class="text-gray-200">
                    <?= $post['description'] ?>
                    <p class="bg-yellow-100 text-yellow-800 p-4 rounded-lg border-l-4 border-yellow-500 text-sm md:text-base">
                        <strong>Note:</strong> Documents or software hosted on <span class="font-semibold">WeShare.com</span> are not owned by this site. We do not hold any licenses. If you are the copyright owner and wish to request removal, please <a href="/contact" class="underline text-blue-600 hover:text-blue-800">contact us</a> and we will remove it promptly.
                    </p>
