...
{
    $isActive = (strpos($currentPage, $page) !== false || ($page === '/' && $currentPage === 'index'));
    $baseUrl = $page === '/' ? '/' : $page;
    $params = ['lang' => $lang];
...
<style>
    <style>.nav-link {
        @apply relative rounded-md text-base font-medium p-2 text-white hover:text-white hover:bg-green-600;
    }

    .nav-link.active::after {
        content: '';
        @apply absolute left-0 right-0 bottom-0 h-[2px] bg-white rounded;
    }
</style>
