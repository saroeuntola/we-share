...
<body class="bg-gray-900 text-white">
  ...
  <div id="pageLoader"
    ...
    <!-- Loader Spinner -->
    <div class="relative h-20 w-20​​ flex flex-col justify-center items-center">
      <div class="loader inset-0 ease-linear"></div>
      <span class="text-white text-sm font-medium <?= $lang === 'kh' ? 'khmer-font' : '' ?>">
        <?= $lang === 'en' ? 'Loading...' : 'សូមរងចាំ' ?>
      </span>
