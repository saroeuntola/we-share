    ...
    <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 ">
        ...
        <div class="mt-6 me-4">
            ...
            <p class="text-sm leading-relaxed text-wrap">
               <?= $lang === 'en' ? 'We Share is a free platform offering Khmer-language documents, study materials, IT document, and free PDF downloads. Our goal is to provide accessible learning materials to everyone and promote knowledge sharing across all fields.' :  ?>
