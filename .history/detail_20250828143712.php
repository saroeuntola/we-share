            ...
            <div class="bg-gray-800 text-white p-3">
                ...
                <div class="text-gray-200">
                    ...
                    <div class=" text-amber-500 rounded-lg text-sm md:text-base mt-4">
                        <strong class="">Note:</strong> Documents or software hosted on <span class="font-semibold">WeShare.com</span> are not owned by this site. If you are the copyright owner and wish to request removal, please <a href="/contact" class="underline text-blue-600 hover:text-blue-800">contact us</a> and we will remove it promptly.
                    </div>
                </div>
