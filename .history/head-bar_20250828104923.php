...
$menu = [
    'home' => $lang === 'en' ? 'Home' : 'ទំព័រ',
    'services' => $lang === 'en' ? 'Services' : 'សេវាកម្ម',
    'about' => $lang === 'en' ? 'About' : 'អំពី',
...
<nav class="bg-green-500 shadow-md w-full" id="header">
    <div class="max-w-7xl mx-auto px-2">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center lg:hidden">
                ...
                <button id="menu-btn" class="focus:outline-none">
                    <!-- Hamburger -->
                    <svg id="menu-icon" class="h-7 w-7 text-white mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
                    </svg>

                    <!-- Close -->
                    <svg id="close-icon" class="h-7 w-7 text-white hidden mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="hidden lg:flex justify-between items-center w-full">
                ...
                <div class="flex space-x-6 items-center">
                    <a href="/?lang=<?php echo $lang; ?>" class="rounded-md text-base font-medium text-white hover:bg-green-600 p-2"><?php echo $menu['home']; ?></a>
                    <a href="services?lang=<?php echo $lang; ?>" class="rounded-md text-base font-medium text-white hover:bg-green-600 p-2"><?php echo $menu['services']; ?></a>
                    <a href="about?lang=<?php echo $lang; ?>" class="rounded-md text-base font-medium text-white hover:bg-green-600 p-2"><?php echo $menu['about']; ?></a>
        ...
        <div id="mobile-menu" class="hidden lg:hidden px-2 pt-2 pb-3 space-y-1">

            <a href="/?lang=<?php echo $lang; ?>" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-green-600"><?php echo $menu['home']; ?></a>
            <a href="services?lang=<?php echo $lang; ?>" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-green-600"><?php echo $menu['services']; ?></a>
            <a href="about?lang=<?php echo $lang; ?>" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-green-600"><?php echo $menu['about']; ?></a>
        </div>
</nav>
