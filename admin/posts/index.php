...
$posts = $postModel->getPostsNolang();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_post'])) {
    ...
    if ($post_id && empty($uploadedImage)) {
        if (method_exists($postModel, 'getPostById')) {
            $existing = $postModel->getPostBySlugNolang($post_id);
    ...
    if ($post_id) {
        ...
        $postModel->updatePostById($post_id, $name_en, $category_id, $subcategory_id, $description_en, $uploadedImage, $name_kh, $description_kh, $link);
    } else {

        try {

            $postModel->createPost($name_en, $category_id, $subcategory_id, $description_en, $uploadedImage, $name_kh, $description_kh, $added_by, $link);
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2"><?= htmlspecialchars($p['name_en'] ?? '') ?></td>
                ...
                <div class="relative mt-12 mb-12 mx-auto max-w-3xl bg-white rounded-lg shadow-lg p-6 w-full">
                    ...
                    <form method="POST" onsubmit="submitQuillContent()" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div>
                            ...
                            <div id="currentImageWrapper" class="mt-2 hidden">
                                <p class="text-sm text-gray-600 mb-1">Current Image:</p>
                                <a href="#" id="currentImageLink" target="_blank">
    ...
    <script>
        ...
        function openModal(post = null) {
            ...
            if (post) {
                ...
                document.getElementById('name_en').value = post.name_en;
                ...
                // Load subcategory with preselected value
                ...
                document.getElementById('current_image').value = post.post_image || post.image || '';

                // show preview if image exists
                if (post.post_image || post.image) {
                    previewImg.src = 'uploads/' + (post.post_image || post.image);
